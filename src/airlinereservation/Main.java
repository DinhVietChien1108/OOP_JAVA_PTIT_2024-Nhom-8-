...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ImageIcon icon = new ImageIcon("D:\\NetBean\\AirlineReservation\\src\\airlinereservation\\images\\bkg.jpg");
        // tạo một ImageIcon từ tệp hình ảnh
        JLabel backgroundLabel = new JLabel(icon);
        // tạo một JLabel với ImageIcon làm nền
        backgroundLabel.setBounds(0, 0, icon.getIconWidth(), icon.getIconHeight());
        // thiết lập kích thước của JLabel để bằng kích thước của hình ảnh
        jDesktopPane1.add(backgroundLabel, new Integer(Integer.MIN_VALUE));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/airlinereservation/images/main.png"))); // NOI18N
        ...
        jDesktopPane1Layout.setHorizontalGroup(
            ...
            .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 1196, Short.MAX_VALUE)
        );
