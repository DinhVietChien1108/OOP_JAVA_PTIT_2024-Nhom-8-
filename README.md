...
Xây dựng một ứng dụng quản lý quán cà phê nhằm tối ưu hóa quá trình quản lý, giúp chủ quán và nhân viên thực hiện công việc một cách hiệu quả và thuận lợi. Ứng 

dụng này sẽ cung cấp các chức năng cơ bản để quản lý các hoạt động hàng ngày của quán cà phê.
...
3. Lớp Category (Danh mục sản phẩm)
...
13. Lớp BillDetail (Chi tiết hóa đơn)
